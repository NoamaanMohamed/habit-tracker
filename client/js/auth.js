async function requestLogin(e){
    ...
    try {
        ...
        console.log(options)
        const r = await fetch(`whispering-lowlands-57408.herokuapp.com//auth/login`, options)
...
async function requestRegistration(e) {
    ...
    try {
        ...
        console.log(options);
        const r = await fetch(`whispering-lowlands-57408.herokuapp.com//auth/register`, options)
        const data = await r.json()
        console.log(data);
